...
fn intersect_scene(r: ptr<function, Ray>, hit: ptr<function, HitInfo>) -> bool {
	...
	let plane_s = 0.2 * uniforms.texture_scaling;
	...
	if (intersect_plane(*r, hit, plane_position, plane_onb.normal)) {
		if (uniforms.texture_enabled == 0u) {
			...
			let texture_color = texture_map(my_texture, vec2f(u, v) * plane_s, true);
			hit.diffuse = texture_color * 0.9;
			hit.ambient = texture_color * 0.1;
		}
		else {
